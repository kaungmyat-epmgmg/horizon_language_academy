                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($students as $student): ?>
                                    <tr>
                                        <td class="id-col"><?php echo $student['enrollment_id'] ?></td>
                                        ...
                                        <td class="application-col"><?php echo $student['course_name'] ?></td>
                                        <td class="status-col"><?php echo $student['batch_no'] ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
